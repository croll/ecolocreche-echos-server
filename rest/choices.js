...
module.exports = function(server, epilogue, models, permchecks) {
     ...
     */
    server.get('/rest/hist/choices', function (req, res, next) {
     ...
     * add a new choice
     */
    server.post('/rest/hist/choices/:id_choice_parent', function (req, res, next) {
     ...
     * edit a choice
     */
    server.put('/rest/hist/choices/:id_choice', function (req, res, next) {
